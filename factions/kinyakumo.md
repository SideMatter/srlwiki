...
* Kinyakumo is a trade oriented nation.
* Kinyakumo has the ability to immedietly leave realm when threatened, with its quantum-imaginary technology.
* Tech-only nation, everything Kinyakumo is researching or has are all based off of real life quantum physics topics.
* Giant Robot by the palace
* East Asian styled builds, along with industrial/brutalist styles building, Most Kinyakumo buildings are massive (Uni coming soon!!!)
